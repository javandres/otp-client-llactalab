otp.config = {
  ...
  //File should be loaded in index.htmlEnglish
  locales: {
  ...
  languageChooser: function () {
    ...
    for (var i = 0; i < localesLength; i++) {
      ...
      str +=
        ...
        $.param(url_param) +
        '">' +
        current_locale.config.name +
        " (" +
        current_locale.config.locale_short +
        ")</a></li>";
    }
    str += "</ul>";
    return str;
  ...
  restService: "otp/routers/cuenca",
  ...
  initLatLng: new L.LatLng(-2.90395, -79.00406),
  initZoom: 13,
  // minZoom : 10,
  // maxZoom : 20,
  ...
  logoGraphic:
    "https://llactalab.ucuenca.edu.ec/wp-content/uploads/2020/02/logos.png",
  ...
  infoWidgetLangChooser: {
    title:
      '<img src="/images/language_icon.svg" onerror="this.onerror=\'\';this.src=\'/images/language_icon.png\'" width="30px" height="30px"/>',
    languages: true,
  },
...
otp.config.modes = {
  ...
  //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
  //Options widgets)
  "TRAM,WALK": "Sólo Tranvía",
  "TRAM,BICYCLE": "Bicicleta y Tranvía",
  //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
  //Options widgets)
  ...
  "TRANSIT,WALK,BICYCLE_RENT": "BiciPública y Transporte Público",
